...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Catlogo libroT2 = new Libro("1111111000011", "herry potter", LocalDate.of(1997, 6, 26), 1000, "J.K. Rowling", "Fantasy");
            ...
            Catlogo rivista5 = new Riviste("1111111000024", "Avengers", LocalDate.of(1997, 1, 5), 650, Periodicita.ANNUALE);
            ...
            archivio.add(rivista5, libro2);

            //rimozione di un elemento
            archivio.cancellaByIsdn("1111111000010");
            //ricerca per isbn
            archivio.cercaIsbn("1111111000011").forEach(System.out::println);
            //ricerca per anno di publicazione
            archivio.cercaAnnoPub(1997);
            //ricerca per autore
            archivio.cercaAutore("J.K. ");
            archivio.save();//salvo su file
            // Carica da file
            //
            List<Catlogo> file = archivio.carica();
            archivio.setCatalogo(file);//carico il file e poi risetto il catalogo archivo
